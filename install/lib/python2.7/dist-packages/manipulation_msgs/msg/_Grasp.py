...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d2f3I.pack(_x.approach.direction.vector.x, _x.approach.direction.vector.y, _x.approach.direction.vector.z, _x.approach.desired_distance, _x.approach.min_distance, _x.retreat.direction.header.seq, _x.retreat.direction.header.stamp.secs, _x.retreat.direction.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3f.pack(_x.retreat.direction.vector.x, _x.retreat.direction.vector.y, _x.retreat.direction.vector.z, _x.retreat.desired_distance, _x.retreat.min_distance, _x.max_contact_force))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.approach.direction.vector.x, _x.approach.direction.vector.y, _x.approach.direction.vector.z, _x.approach.desired_distance, _x.approach.min_distance, _x.retreat.direction.header.seq, _x.retreat.direction.header.stamp.secs, _x.retreat.direction.header.stamp.nsecs,) = _struct_3d2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.retreat.direction.vector.x, _x.retreat.direction.vector.y, _x.retreat.direction.vector.z, _x.retreat.desired_distance, _x.retreat.min_distance, _x.max_contact_force,) = _struct_3d3f.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.allowed_touch_objects = []
