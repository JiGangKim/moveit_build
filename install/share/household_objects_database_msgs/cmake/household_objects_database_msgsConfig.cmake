...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'household_objects_database_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donghoonpark/moveit/install/${idir}'.  Ask the maintainer 'Matei Ciocarlie <matei.ciocarlie@gmail.com>' to fix it.")
    endif()
