...
class GetPlanningSceneRequest {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = PlanningSceneComponents.serialize(obj.components, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new GetPlanningSceneRequest();
    // Deserialize message field [components]
    tmp = PlanningSceneComponents.deserialize(buffer);
...
class GetPlanningSceneResponse {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = PlanningScene.serialize(obj.scene, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new GetPlanningSceneResponse();
