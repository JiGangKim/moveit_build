...
class PlanningOptions {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = PlanningScene.serialize(obj.planning_scene_diff, bufferInfo);
    // Serialize message field [plan_only]
    bufferInfo = _serializer.bool(obj.plan_only, bufferInfo);
    // Serialize message field [look_around]
    bufferInfo = _serializer.bool(obj.look_around, bufferInfo);
    // Serialize message field [look_around_attempts]
    bufferInfo = _serializer.int32(obj.look_around_attempts, bufferInfo);
    // Serialize message field [max_safe_execution_cost]
    bufferInfo = _serializer.float64(obj.max_safe_execution_cost, bufferInfo);
    // Serialize message field [replan]
    bufferInfo = _serializer.bool(obj.replan, bufferInfo);
    // Serialize message field [replan_attempts]
    bufferInfo = _serializer.int32(obj.replan_attempts, bufferInfo);
    // Serialize message field [replan_delay]
    bufferInfo = _serializer.float64(obj.replan_delay, bufferInfo);
    return bufferInfo;
  }
