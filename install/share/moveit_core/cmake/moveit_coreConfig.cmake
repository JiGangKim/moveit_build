...
if(NOT "/usr/include/eigen3;include;/opt/ros/kinetic/include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donghoonpark/moveit/install/${idir}'.  Ask the maintainer 'Sachin Chitta <robot.moveit@gmail.com>, Ioan Sucan <isucan@gmail.com>, Acorn Pooley <acorn.pooley@sri.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/donghoonpark/moveit/install/lib;/home/donghoonpark/catkin_workspace/install/lib;/opt/ros/kinetic/lib)
