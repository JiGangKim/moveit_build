...
if(NOT "/usr/include/eigen3;include;/opt/ros/kinetic/include;/usr/include " STREQUAL " ")
  set(moveit_core_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/eigen3;include;/opt/ros/kinetic/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donghoonpark/moveit/install_isolated/${idir}'.  Ask the maintainer 'Sachin Chitta <robot.moveit@gmail.com>, Ioan Sucan <isucan@gmail.com>, Acorn Pooley <acorn.pooley@sri.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/donghoonpark/moveit/install_isolated/lib;/home/donghoonpark/moveit/devel_isolated/srdfdom/lib;/home/donghoonpark/moveit/devel_isolated/moveit_ros/lib;/home/donghoonpark/moveit/devel_isolated/moveit_resources/lib;/home/donghoonpark/moveit/devel_isolated/moveit_plugins/lib;/home/donghoonpark/moveit/devel_isolated/moveit_planners/lib;/home/donghoonpark/moveit/devel_isolated/moveit_msgs/lib;/home/donghoonpark/moveit/devel_isolated/manipulation_msgs/lib;/home/donghoonpark/moveit/devel_isolated/household_objects_database_msgs/lib;/home/donghoonpark/catkin_workspace/install/lib;/opt/ros/kinetic/lib)
