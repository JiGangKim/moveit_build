...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/donghoonpark/moveit/install_isolated/lib/python2.7/dist-packages:/home/donghoonpark/moveit/build_isolated/moveit_ros_visualization/lib/python2.7/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/donghoonpark/moveit/build_isolated/moveit_ros_visualization" \
    "/usr/bin/python" \
    "/home/donghoonpark/moveit/src/moveit_ros/visualization/setup.py" \
    build --build-base "/home/donghoonpark/moveit/build_isolated/moveit_ros_visualization" \
    install \
    $DESTDIR_ARG \
