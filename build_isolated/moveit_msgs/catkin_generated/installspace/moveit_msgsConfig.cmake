...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donghoonpark/moveit/install_isolated/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/donghoonpark/moveit/install_isolated/lib;/home/donghoonpark/moveit/devel_isolated/manipulation_msgs/lib;/home/donghoonpark/moveit/devel_isolated/household_objects_database_msgs/lib;/home/donghoonpark/catkin_workspace/install/lib;/opt/ros/kinetic/lib)
