...
if(NOT "/usr/include/eigen3;include " STREQUAL " ")
  set(moveit_ros_planning_interface_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/eigen3;include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_ros_planning_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donghoonpark/moveit/install_isolated/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
