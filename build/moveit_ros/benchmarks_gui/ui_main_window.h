...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        planning_group_combo->setObjectName(QStringLiteral("planning_group_combo"));
        ...
        db_combo->setObjectName(QStringLiteral("db_combo"));
        ...
        db_connect_button->setObjectName(QStringLiteral("db_connect_button"));
        ...
        robot_interaction_button->setObjectName(QStringLiteral("robot_interaction_button"));
        ...
        planning_scene_list->setObjectName(QStringLiteral("planning_scene_list"));
        ...
        goal_poses_and_states->setObjectName(QStringLiteral("goal_poses_and_states"));
        ...
        load_poses_filter_text->setObjectName(QStringLiteral("load_poses_filter_text"));
        ...
        goal_poses_open_button->setObjectName(QStringLiteral("goal_poses_open_button"));
        ...
        goal_poses_add_button->setObjectName(QStringLiteral("goal_poses_add_button"));
        ...
        goal_poses_remove_button->setObjectName(QStringLiteral("goal_poses_remove_button"));
        ...
        goal_poses_save_button->setObjectName(QStringLiteral("goal_poses_save_button"));
        ...
        goal_switch_visibility_button->setObjectName(QStringLiteral("goal_switch_visibility_button"));
        ...
        goal_poses_list->setObjectName(QStringLiteral("goal_poses_list"));
        ...
        show_x_checkbox->setObjectName(QStringLiteral("show_x_checkbox"));
        ...
        show_y_checkbox->setObjectName(QStringLiteral("show_y_checkbox"));
        show_y_checkbox->setChecked(false);

        horizontalLayout_2->addWidget(show_y_checkbox);

        show_z_checkbox = new QCheckBox(groupBox);
        show_z_checkbox->setObjectName(QStringLiteral("show_z_checkbox"));
        ...
        goal_offset_roll->setObjectName(QStringLiteral("goal_offset_roll"));
        ...
        goal_offset_pitch->setObjectName(QStringLiteral("goal_offset_pitch"));
        ...
        goal_offset_yaw->setObjectName(QStringLiteral("goal_offset_yaw"));
        ...
        check_goal_collisions_button->setObjectName(QStringLiteral("check_goal_collisions_button"));

        horizontalLayout_10->addWidget(check_goal_collisions_button);

        check_goal_reachability_button = new QPushButton(groupBox);
        check_goal_reachability_button->setObjectName(QStringLiteral("check_goal_reachability_button"));
        ...
        load_results_button->setObjectName(QStringLiteral("load_results_button"));
        ...
        trajectories_filter_text->setObjectName(QStringLiteral("trajectories_filter_text"));

        horizontalLayout_3->addWidget(trajectories_filter_text);

        trajectory_open_button = new QPushButton(groupBox_2);
        trajectory_open_button->setObjectName(QStringLiteral("trajectory_open_button"));
        ...
        trajectory_add_button->setObjectName(QStringLiteral("trajectory_add_button"));
        ...
        trajectory_remove_button->setObjectName(QStringLiteral("trajectory_remove_button"));
        ...
        trajectory_save_button->setObjectName(QStringLiteral("trajectory_save_button"));
        ...
        trajectory_list->setObjectName(QStringLiteral("trajectory_list"));
        ...
        trajectory_nwaypoints_label->setObjectName(QStringLiteral("trajectory_nwaypoints_label"));
        ...
        trajectory_nwaypoints_spin->setObjectName(QStringLiteral("trajectory_nwaypoints_spin"));
        ...
        trajectory_execute_button->setObjectName(QStringLiteral("trajectory_execute_button"));
        ...
        tab_start_states->setObjectName(QStringLiteral("tab_start_states"));
        ...
        load_states_filter_text->setObjectName(QStringLiteral("load_states_filter_text"));
        ...
        start_states_open_button->setObjectName(QStringLiteral("start_states_open_button"));
        ...
        start_states_add_button->setObjectName(QStringLiteral("start_states_add_button"));
        ...
        start_states_remove_button->setObjectName(QStringLiteral("start_states_remove_button"));
        ...
        start_states_save_button->setObjectName(QStringLiteral("start_states_save_button"));
        ...
        start_states_list->setObjectName(QStringLiteral("start_states_list"));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Benchmark tool", 0));
        actionOpen->setText(QApplication::translate("MainWindow", "Load robot...", 0));
        actionExit->setText(QApplication::translate("MainWindow", "Exit", 0));
        label->setText(QApplication::translate("MainWindow", "Planning group:", 0));
#ifndef QT_NO_TOOLTIP
        planning_group_combo->setToolTip(QApplication::translate("MainWindow", "Planning group", 0));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("MainWindow", "Warehouse:", 0));
        db_connect_button->setText(QApplication::translate("MainWindow", "Connect", 0));
        robot_interaction_button->setText(QApplication::translate("MainWindow", "Robot interaction", 0));
        load_scene_button->setText(QApplication::translate("MainWindow", "Load Scene", 0));
        tabWidget->setTabText(tabWidget->indexOf(stored_plans), QApplication::translate("MainWindow", " Scenes", 0));
        groupBox->setTitle(QApplication::translate("MainWindow", "Goals", 0));
#ifndef QT_NO_TOOLTIP
        load_poses_filter_text->setToolTip(QString());
#endif // QT_NO_TOOLTIP
        load_poses_filter_text->setText(QApplication::translate("MainWindow", ".*", 0));
#ifndef QT_NO_TOOLTIP
        goal_poses_open_button->setToolTip(QApplication::translate("MainWindow", "Load from database", 0));
#endif // QT_NO_TOOLTIP
        goal_poses_open_button->setText(QString());
#ifndef QT_NO_TOOLTIP
        goal_poses_add_button->setToolTip(QApplication::translate("MainWindow", "New goal in the current end-effector pose", 0));
#endif // QT_NO_TOOLTIP
        goal_poses_add_button->setText(QString());
#ifndef QT_NO_TOOLTIP
        goal_poses_remove_button->setToolTip(QApplication::translate("MainWindow", "Remove selected goals", 0));
#endif // QT_NO_TOOLTIP
        goal_poses_remove_button->setText(QString());
#ifndef QT_NO_TOOLTIP
        goal_poses_save_button->setToolTip(QApplication::translate("MainWindow", "Apply changes", 0));
#endif // QT_NO_TOOLTIP
        goal_poses_save_button->setText(QString());
#ifndef QT_NO_TOOLTIP
        goal_switch_visibility_button->setToolTip(QApplication::translate("MainWindow", "Switch vibility of selected goals", 0));
#endif // QT_NO_TOOLTIP
        goal_switch_visibility_button->setText(QString());
#ifndef QT_NO_TOOLTIP
        goal_poses_list->setToolTip(QApplication::translate("MainWindow", "Press Ctrl+D to duplicate the selected goals", 0));
#endif // QT_NO_TOOLTIP
        show_x_checkbox->setText(QApplication::translate("MainWindow", "Show X", 0));
        show_y_checkbox->setText(QApplication::translate("MainWindow", "Show Y", 0));
        show_z_checkbox->setText(QApplication::translate("MainWindow", "Show Z", 0));
        groupBox_3->setTitle(QApplication::translate("MainWindow", "Goal offset", 0));
        label_3->setText(QApplication::translate("MainWindow", "Roll:", 0));
        label_4->setText(QApplication::translate("MainWindow", "Pitch:", 0));
        label_5->setText(QApplication::translate("MainWindow", "Yaw:", 0));
...
"reachability", 0));
        run_benchmark_button->setText(QApplication::translate("MainWindow", "Run benchmark or generate config file", 0));
        load_results_button->setText(QApplication::translate("MainWindow", "Load benchmark results", 0));
        groupBox_2->setTitle(QApplication::translate("MainWindow", "Cartesian trajectories", 0));
        trajectories_filter_text->setInputMask(QString());
        trajectories_filter_text->setText(QApplication::translate("MainWindow", ".*", 0));
        ...
        trajectory_nwaypoints_label->setText(QApplication::translate("MainWindow", "Number of waypoints", 0));
        trajectory_execute_button->setText(QApplication::translate("MainWindow", "Execute Interpolated IK", 0));
        tabWidget->setTabText(tabWidget->indexOf(goal_poses_and_states), QApplication::translate("MainWindow", "Queries", 0));
        load_states_filter_text->setText(QApplication::translate("MainWindow", ".*", 0));
#ifndef QT_NO_TOOLTIP
        start_states_open_button->setToolTip(QApplication::translate("MainWindow", "Load from database", 0));
#endif // QT_NO_TOOLTIP
        start_states_open_button->setText(QString());
#ifndef QT_NO_TOOLTIP
        start_states_add_button->setToolTip(QApplication::translate("MainWindow", "Store current start state", 0));
#endif // QT_NO_TOOLTIP
        start_states_add_button->setText(QString());
#ifndef QT_NO_TOOLTIP
        start_states_remove_button->setToolTip(QApplication::translate("MainWindow", "Remove selected start states", 0));
#endif // QT_NO_TOOLTIP
        start_states_remove_button->setText(QString());
#ifndef QT_NO_TOOLTIP
        start_states_save_button->setToolTip(QApplication::translate("MainWindow", "Apply changes", 0));
#endif // QT_NO_TOOLTIP
        start_states_save_button->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab_start_states), QApplication::translate("MainWindow", "Start states", 0));
