...
struct qt_meta_stringdata_BenchmarkProcessingThread_t {
    QByteArrayData data[1];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BenchmarkProcessingThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BenchmarkProcessingThread_t qt_meta_stringdata_BenchmarkProcessingThread = {
    {
QT_MOC_LITERAL(0, 0, 25) // "BenchmarkProcessingThread"
...
const QMetaObject BenchmarkProcessingThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_BenchmarkProcessingThread.data,
      qt_meta_data_BenchmarkProcessingThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BenchmarkProcessingThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BenchmarkProcessingThread.stringdata0))
