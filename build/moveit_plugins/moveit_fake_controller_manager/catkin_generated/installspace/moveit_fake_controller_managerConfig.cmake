...
if("FALSE" STREQUAL "TRUE")
  ...
  set(moveit_fake_controller_manager_DEVEL_PREFIX /home/donghoonpark/moveit/devel)
  ...
  set(moveit_fake_controller_manager_INSTALL_PREFIX /home/donghoonpark/moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_fake_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donghoonpark/moveit/install/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
