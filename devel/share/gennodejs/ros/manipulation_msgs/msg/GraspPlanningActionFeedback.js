...
class GraspPlanningActionFeedback {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = GraspPlanningFeedback.serialize(obj.feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new GraspPlanningActionFeedback();
    ...
    tmp = GraspPlanningFeedback.deserialize(buffer);
