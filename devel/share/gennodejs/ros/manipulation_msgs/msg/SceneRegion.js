...
class SceneRegion {
  ...
  static serialize(obj, bufferInfo) {
    ...
    // Serialize the length for message field [mask]
    bufferInfo = _serializer.uint32(obj.mask.length, bufferInfo);
    // Serialize message field [mask]
    obj.mask.forEach((val) => {
    ...
    bufferInfo = sensor_msgs.msg.Image.serialize(obj.disparity_image, bufferInfo);
    // Serialize message field [cam_info]
    bufferInfo = sensor_msgs.msg.CameraInfo.serialize(obj.cam_info, bufferInfo);
    // Serialize message field [roi_box_pose]
    bufferInfo = geometry_msgs.msg.PoseStamped.serialize(obj.roi_box_pose, bufferInfo);
    // Serialize message field [roi_box_dims]
    bufferInfo = geometry_msgs.msg.Vector3.serialize(obj.roi_box_dims, bufferInfo);
    return bufferInfo;
  }
