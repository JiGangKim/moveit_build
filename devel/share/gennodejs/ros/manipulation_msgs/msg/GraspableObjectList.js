...
class GraspableObjectList {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = _serializer.uint32(obj.graspable_objects.length, bufferInfo);
    ...
    bufferInfo = sensor_msgs.msg.CameraInfo.serialize(obj.camera_info, bufferInfo);
    ...
    bufferInfo = geometry_msgs.msg.Pose.serialize(obj.reference_to_camera, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new GraspableObjectList();
    ...
    for (let i = 0; i < len; ++i) {
      ...
      data.graspable_objects[i] = tmp.data;
      buffer = tmp.buffer;
    }
    ...
    data.reference_to_camera = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
      buffer: buffer
