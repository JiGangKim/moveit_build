...
class GetConstraintAwarePositionIKRequest {
  constructor() {
  ...
  static serialize(obj, bufferInfo) {
    // Serializes a message object of type GetConstraintAwarePositionIKRequest
    // Serialize message field [ik_request]
    bufferInfo = PositionIKRequest.serialize(obj.ik_request, bufferInfo);
  ...
  static deserialize(buffer) {
    //deserializes a message object of type GetConstraintAwarePositionIKRequest
    let tmp;
    let len;
    let data = new GetConstraintAwarePositionIKRequest();
    // Deserialize message field [ik_request]
    tmp = PositionIKRequest.deserialize(buffer);
    data.ik_request = tmp.data;
    buffer = tmp.buffer;
...
class GetConstraintAwarePositionIKResponse {
  constructor() {
  ...
  static serialize(obj, bufferInfo) {
    // Serializes a message object of type GetConstraintAwarePositionIKResponse
    // Serialize message field [solution]
    bufferInfo = RobotState.serialize(obj.solution, bufferInfo);
  ...
  static deserialize(buffer) {
    //deserializes a message object of type GetConstraintAwarePositionIKResponse
    let tmp;
    let len;
    let data = new GetConstraintAwarePositionIKResponse();
...
module.exports = {
  ...
  Response: GetConstraintAwarePositionIKResponse
};
