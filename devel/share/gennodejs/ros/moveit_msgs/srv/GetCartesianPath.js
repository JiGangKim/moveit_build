...
class GetCartesianPathRequest {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = _serializer.float64(obj.max_step, bufferInfo);
    // Serialize message field [jump_threshold]
    bufferInfo = _serializer.float64(obj.jump_threshold, bufferInfo);
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new GetCartesianPathRequest();
    ...
    data.max_step = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [jump_threshold]
    tmp = _deserializer.float64(buffer);
    data.jump_threshold = tmp.data;
    buffer = tmp.buffer;
...
class GetCartesianPathResponse {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = RobotTrajectory.serialize(obj.solution, bufferInfo);
    // Serialize message field [fraction]
    bufferInfo = _serializer.float64(obj.fraction, bufferInfo);
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new GetCartesianPathResponse();
    // Deserialize message field [start_state]
    tmp = RobotState.deserialize(buffer);
    data.start_state = tmp.data;
    buffer = tmp.buffer;
