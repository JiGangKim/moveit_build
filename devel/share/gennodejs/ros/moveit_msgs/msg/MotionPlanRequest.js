...
class MotionPlanRequest {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = WorkspaceParameters.serialize(obj.workspace_parameters, bufferInfo);
    // Serialize message field [start_state]
    bufferInfo = RobotState.serialize(obj.start_state, bufferInfo);
    // Serialize the length for message field [goal_constraints]
    bufferInfo = _serializer.uint32(obj.goal_constraints.length, bufferInfo);
    // Serialize message field [goal_constraints]
    obj.goal_constraints.forEach((val) => {
      bufferInfo = Constraints.serialize(val, bufferInfo);
    });
    ...
    bufferInfo = TrajectoryConstraints.serialize(obj.trajectory_constraints, bufferInfo);
    ...
    bufferInfo = _serializer.int32(obj.num_planning_attempts, bufferInfo);
    ...
    bufferInfo = _serializer.float64(obj.max_velocity_scaling_factor, bufferInfo);
    // Serialize message field [max_acceleration_scaling_factor]
    bufferInfo = _serializer.float64(obj.max_acceleration_scaling_factor, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new MotionPlanRequest();
    // Deserialize message field [workspace_parameters]
    tmp = WorkspaceParameters.deserialize(buffer);
    data.workspace_parameters = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [start_state]
    tmp = RobotState.deserialize(buffer);
    data.start_state = tmp.data;
    buffer = tmp.buffer;
    ...
    for (let i = 0; i < len; ++i) {
      ...
      data.goal_constraints[i] = tmp.data;
      buffer = tmp.buffer;
    }
    ...
    tmp = TrajectoryConstraints.deserialize(buffer);
    data.trajectory_constraints = tmp.data;
    buffer = tmp.buffer;
    ...
    data.num_planning_attempts = tmp.data;
    buffer = tmp.buffer;
    ...
    tmp = _deserializer.float64(buffer);
    data.max_velocity_scaling_factor = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [max_acceleration_scaling_factor]
    tmp = _deserializer.float64(buffer);
    data.max_acceleration_scaling_factor = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
      buffer: buffer
