...
class MoveGroupAction {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = MoveGroupActionGoal.serialize(obj.action_goal, bufferInfo);
    // Serialize message field [action_result]
    bufferInfo = MoveGroupActionResult.serialize(obj.action_result, bufferInfo);
    // Serialize message field [action_feedback]
    bufferInfo = MoveGroupActionFeedback.serialize(obj.action_feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new MoveGroupAction();
    // Deserialize message field [action_goal]
    tmp = MoveGroupActionGoal.deserialize(buffer);
    data.action_goal = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_result]
    tmp = MoveGroupActionResult.deserialize(buffer);
    data.action_result = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_feedback]
    tmp = MoveGroupActionFeedback.deserialize(buffer);
