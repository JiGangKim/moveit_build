  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.graspable_objects:
        ...
        buff.write(_struct_9d.pack(*_v21.K))
        buff.write(_struct_9d.pack(*_v21.R))
        buff.write(_struct_12d.pack(*_v21.P))
        _x = _v21
      ...
      for val1 in self.meshes:
        ...
        for val2 in val1.vertices:
          ...
          buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
      _x = self
      buff.write(_struct_7d.pack(_x.reference_to_camera.position.x, _x.reference_to_camera.position.y, _x.reference_to_camera.position.z, _x.reference_to_camera.orientation.x, _x.reference_to_camera.orientation.y, _x.reference_to_camera.orientation.z, _x.reference_to_camera.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v52.K = _struct_9d.unpack(str[start:end])
        start = end
        end += 72
        _v52.R = _struct_9d.unpack(str[start:end])
        start = end
        end += 96
        _v52.P = _struct_12d.unpack(str[start:end])
        _x = _v52
        start = end
        end += 8
      ...
      (_x.reference_to_camera.position.x, _x.reference_to_camera.position.y, _x.reference_to_camera.position.z, _x.reference_to_camera.orientation.x, _x.reference_to_camera.orientation.y, _x.reference_to_camera.orientation.z, _x.reference_to_camera.orientation.w,) = _struct_7d.unpack(str[start:end])
      return self
    ...
    try:
      ...
      for val1 in self.graspable_objects:
        ...
        if type(_x) in [list, tuple]:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_B.pack(_v74.is_dense))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v105.is_dense,) = _struct_B.unpack(str[start:end])
