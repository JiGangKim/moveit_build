...
if("TRUE" STREQUAL "TRUE")
  set(household_objects_database_msgs_SOURCE_PREFIX /home/donghoonpark/moveit/src/household_objects_database_msgs)
  set(household_objects_database_msgs_DEVEL_PREFIX /home/donghoonpark/moveit/devel_isolated/household_objects_database_msgs)
  ...
  set(household_objects_database_msgs_INSTALL_PREFIX /home/donghoonpark/moveit/install_isolated)
...
if(NOT "/home/donghoonpark/moveit/devel_isolated/household_objects_database_msgs/include " STREQUAL " ")
  set(household_objects_database_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/donghoonpark/moveit/devel_isolated/household_objects_database_msgs/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'household_objects_database_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Matei Ciocarlie <matei.ciocarlie@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'household_objects_database_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donghoonpark/moveit/src/household_objects_database_msgs/${idir}'.  Ask the maintainer 'Matei Ciocarlie <matei.ciocarlie@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/donghoonpark/moveit/devel_isolated/household_objects_database_msgs/lib;/home/donghoonpark/catkin_workspace/install/lib;/opt/ros/kinetic/lib)
