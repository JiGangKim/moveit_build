...
if(NOT "/home/donghoonpark/moveit/src/moveit_plugins/moveit_simple_controller_manager/include " STREQUAL " ")
  set(moveit_simple_controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/donghoonpark/moveit/src/moveit_plugins/moveit_simple_controller_manager/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_simple_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/donghoonpark/moveit/src/moveit_plugins/moveit_simple_controller_manager/${idir}'.  Ask the maintainer 'Michael Ferguson <fergs@unboundedrobotics.com>' to fix it.")
    endif()
