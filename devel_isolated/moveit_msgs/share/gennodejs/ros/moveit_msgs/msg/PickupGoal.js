...
class PickupGoal {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = _serializer.string(obj.target_name, bufferInfo);
    // Serialize message field [group_name]
    bufferInfo = _serializer.string(obj.group_name, bufferInfo);
    // Serialize message field [end_effector]
    bufferInfo = _serializer.string(obj.end_effector, bufferInfo);
    // Serialize the length for message field [possible_grasps]
    bufferInfo = _serializer.uint32(obj.possible_grasps.length, bufferInfo);
    ...
    bufferInfo = _serializer.string(obj.support_surface_name, bufferInfo);
    // Serialize message field [allow_gripper_support_collision]
    bufferInfo = _serializer.bool(obj.allow_gripper_support_collision, bufferInfo);
    // Serialize the length for message field [attached_object_touch_links]
    bufferInfo = _serializer.uint32(obj.attached_object_touch_links.length, bufferInfo);
    // Serialize message field [attached_object_touch_links]
    obj.attached_object_touch_links.forEach((val) => {
      bufferInfo = _serializer.string(val, bufferInfo);
    });
    // Serialize message field [minimize_object_distance]
    bufferInfo = _serializer.bool(obj.minimize_object_distance, bufferInfo);
    // Serialize message field [path_constraints]
    bufferInfo = Constraints.serialize(obj.path_constraints, bufferInfo);
    // Serialize message field [planner_id]
    bufferInfo = _serializer.string(obj.planner_id, bufferInfo);
    ...
    bufferInfo = _serializer.float64(obj.allowed_planning_time, bufferInfo);
    // Serialize message field [planning_options]
    bufferInfo = PlanningOptions.serialize(obj.planning_options, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    for (let i = 0; i < len; ++i) {
      ...
      data.possible_grasps[i] = tmp.data;
      buffer = tmp.buffer;
    }
    // Deserialize message field [support_surface_name]
    tmp = _deserializer.string(buffer);
    data.support_surface_name = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [allow_gripper_support_collision]
    tmp = _deserializer.bool(buffer);
    data.allow_gripper_support_collision = tmp.data;
    buffer = tmp.buffer;
    // Deserialize array length for message field [attached_object_touch_links]
    tmp = _deserializer.uint32(buffer);
    len = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [attached_object_touch_links]
    data.attached_object_touch_links = new Array(len);
    for (let i = 0; i < len; ++i) {
      tmp = _deserializer.string(buffer);
      data.attached_object_touch_links[i] = tmp.data;
      buffer = tmp.buffer;
    }
    // Deserialize message field [minimize_object_distance]
    tmp = _deserializer.bool(buffer);
    data.minimize_object_distance = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [path_constraints]
    tmp = Constraints.deserialize(buffer);
    data.path_constraints = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [planner_id]
    tmp = _deserializer.string(buffer);
    data.planner_id = tmp.data;
    buffer = tmp.buffer;
    ...
    data.allowed_planning_time = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [planning_options]
    tmp = PlanningOptions.deserialize(buffer);
    data.planning_options = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
      buffer: buffer
