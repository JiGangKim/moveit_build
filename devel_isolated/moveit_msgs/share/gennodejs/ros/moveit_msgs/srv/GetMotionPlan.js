...
class GetMotionPlanRequest {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = MotionPlanRequest.serialize(obj.motion_plan_request, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new GetMotionPlanRequest();
    // Deserialize message field [motion_plan_request]
    tmp = MotionPlanRequest.deserialize(buffer);
    data.motion_plan_request = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
      buffer: buffer
...
class GetMotionPlanResponse {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = MotionPlanResponse.serialize(obj.motion_plan_response, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new GetMotionPlanResponse();
    // Deserialize message field [motion_plan_response]
    tmp = MotionPlanResponse.deserialize(buffer);
    data.motion_plan_response = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
      buffer: buffer
